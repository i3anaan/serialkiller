	...
	public void readPayload(Payload p) {
		try {
			...
			case WHOISrequestCommand:
				...
				IdentificationResponseMessage irm = new IdentificationResponseMessage(p.address, p.data, new String("4evr " + Thread.currentThread().hashCode()).getBytes(Charsets.UTF_8));
