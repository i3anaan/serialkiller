...
public class ByteArrays {
	 ...
	 * 
	 * @param bytes
	 *            The bytes to shift on.
	 * @param shift
	 *            The amount of places to shift to the left. Shifts to the right
	 *            if negative.
	...
	/**
	 * Convert a byte array to a BitSet object. This method becomes obsolete
	 * once Java 7 is available, then BitSet.valueOf(byte[] bytes) is preferred.
	 * 
	 * @param bytes
	 ...
	 *            The byte array to convert.
	 * @param size
	 *            The size of the BitSet object.
	 * @param offset
	 *            The offset where to place the byte array.
	 * @return The BitSet object.
	 */
	...
	/**
	 * Convert a BitSet object to a byte array. This method becomes obsolete
	 * once Java 7 is available, then BitSet.toByteArray() is preferred.
	 * 
	 * @param data
	 *            The BitSet object to convert.
	 * @param len
